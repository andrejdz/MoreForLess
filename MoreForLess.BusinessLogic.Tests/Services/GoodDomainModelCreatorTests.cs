...
namespace MoreForLess.BusinessLogic.Tests.Services
{
    ...
    public class GoodDomainModelCreatorTests
    {
        ...
        private readonly Mock<IURLParser> _urlParser = new Mock<IURLParser>();
        ...
        {
            this._urlParser.Setup(p => p.Parse(It.IsAny<string>()))
                .Returns(this._urlInfo);
        ...
        {
            // Act
            var actual = await new GoodDomainModelCreatorService(
        ...
        public void GoodDomainModelCreator_CreateGoodDomainModelFromUrlAsync_GoodAlreadyExistException()
        {
            ...
            new GoodDomainModelCreatorService(
                goodService.Object,
                this._mapper.Object,
                this._urlParser.Object,
                this._adapterResolver.Object)
